...
# Reset the game
def reset_game():
    global occupied_points, user_turn, round_count
...
# Main game loop
def main():
    global dragging, selected_point, user_turn, player1_score, player2_score, round_count
                            ...
                            if point in valid_moves[selected_point]:
                                ...
                                if check_winner("B"):
                                    ...
                                    if player2_score == 3:
                                        ...
                                        reset_game()  # Reset after each win
                                    break
